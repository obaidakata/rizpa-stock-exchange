...
public class RizpaXmlParser{
    ...
    public String saveAllData(String fileName, StockExchangeDescriptor descriptor) throws Exception {
        ...
        String xmlFile = fileName + File.separator + "savedData.xml";
        File filePath = new File(xmlFile);
        JAXBContext jaxbContext = JAXBContext.newInstance(StockExchangeDescriptor.class);
        ...
        jaxbMarshaller.marshal(descriptor, filePath);
    ...
    public StockExchangeDescriptor loadPreviousData(String fileName) throws Exception {
        ...
        return (StockExchangeDescriptor) jaxbUnmarshaller.unmarshal(filePath);
    }
}
